...
git@github.com:harsha1010-art/searsch-funtionality.git
...
git clone git@github.com:harsha1010-art/searsch-funtionality.git
cd searsch-funtionality

Alternatively, use the HTTPS URL if SSH is not configured:

git clone https://github.com/harsha1010-art/searsch-funtionality.git
cd searsch-funtionality
